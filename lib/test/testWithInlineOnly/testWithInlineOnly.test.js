...
describe("test with inline env vars and a config file", () => {
  beforeEach(() => {
    shell.default.exec(
      "cross-env front__env_config_target=front back__env_config_target=back sv__SHARED_SECRET=mysharedsecret front__VITE_SECRET=anothersecretforfrontend front__VITE_SHARED_SECRET=sv__SHARED_SECRET back__SECRET=anothersecretforbackend back__SHARED_SECRET=sv__SHARED_SECRET node ./lib/test/testWithInlineOnly/main.js"
    );
  });
