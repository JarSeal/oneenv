...
export const oneEnv = (path, silent) => {
  ...
  for (let i = 0; i < handles.length; i++) {
    ...
    try {
      ...
      console.log("Could not create files:", targetFile, err);
    }
  }
...
export const setEnvVarsToProcessEnvAndGetPath = (path) => {
...
export const getSeparator = (path, configFileContent) => {
...
export const getConfigFileContent = (path) => {
...
export const autoGenerationMessage =
